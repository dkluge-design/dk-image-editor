...
const IconLock = ({ size = 16, color = 'currentColor' }) => {
    return (jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: color, strokeWidth: "2", children: [jsxRuntime.jsx("rect", { x: "3", y: "11", width: "18", height: "11", rx: "2", ry: "2" }), jsxRuntime.jsx("circle", { cx: "12", cy: "16", r: "1" }), jsxRuntime.jsx("path", { d: "M7 11V7a5 5 0 0 1 10 0v4" })] }));
};

const IconUnlock = ({ size = 16, color = 'currentColor' }) => {
    return (jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: color, strokeWidth: "2", children: [jsxRuntime.jsx("rect", { x: "3", y: "11", width: "18", height: "11", rx: "2", ry: "2" }), jsxRuntime.jsx("circle", { cx: "12", cy: "16", r: "1" }), jsxRuntime.jsx("path", { d: "M7 11V7a5 5 0 0 1 9.9-1" })] }));
};

function IconReset(props) {
    const width = props.size || props.width || 20;
    const height = props.size || props.height || 20;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [jsxRuntime.jsx("path", { d: "M3 12a9 9 0 019-9 9.75 9.75 0 016.74 2.74L21 8" }), jsxRuntime.jsx("path", { d: "M21 3v5h-5" }), jsxRuntime.jsx("path", { d: "M21 12a9 9 0 01-9 9 9.75 9.75 0 01-6.74-2.74L3 16" }), jsxRuntime.jsx("path", { d: "M3 21v-5h5" })] }));
}
...
const CropPanel = ({ editorState, cropPresets, editorRef, onStateChange }) => {
    ...
    // 宽高比锁定状态
    const [isAspectLocked, setIsAspectLocked] = React.useState(false);
    // 基于原图尺寸的裁剪宽高（用于输入框显示）
    ...
    // 重新计算图片在画布上的显示位置和尺寸
    const recalculateImageDisplay = React.useCallback(() => {
        const editor = editorRef.current;
    ...
    // 处理旋转操作
    const handleRotation = React.useCallback((angle) => {
    ...
    // 处理翻转操作（水平/垂直）
    const handleFlip = React.useCallback((axis) => {
        const key = `flip${axis}`;
        onStateChange({ [key]: !editorState[key] });
    }, [editorState, onStateChange]);
    // 将原图尺寸转换为显示尺寸并更新裁剪区域
    const updateCropSize = React.useCallback((newWidth, newHeight) => {
        const editor = editorRef.current;
        const imageDisplay = editor.getImageDisplay();
    ...
    // 处理宽度输入变化
    const handleWidthChange = React.useCallback((value) => {
        setCropWidth(value);
    ...
    // 处理高度输入变化
    const handleHeightChange = React.useCallback((value) => {
        setCropHeight(value);
    ...
    return (jsxRuntime.jsxs("div", { className: "dk-image-editor__crop-controls", children: [jsxRuntime.jsxs("div", { className: "dk-image-editor__actions", children: [jsxRuntime.jsx("button", { className: "dk-image-editor__preset-btn", onClick: () => handlePresetClick({ name: 'Original' }), children: jsxRuntime.jsx(IconReset, { size: 14 }) }), jsxRuntime.jsx("select", { className: "dk-image-editor__preset-select", onChange: (e) => {
                            const preset = cropPresets.find((p) => p.name === e.target.value);
                            if (preset)
                                handlePresetClick(preset);
                        }, defaultValue: "", children: cropPresets.map((preset) => (jsxRuntime.jsx("option", { value: preset.name, children: preset.name }, preset.name))) }), jsxRuntime.jsx("button", { onClick: () => handleRotation(ROTATION_ANGLES.NEGATIVE_QUARTER_TURN), children: "-90\u00B0" }), jsxRuntime.jsx("button", { onClick: () => handleRotation(ROTATION_ANGLES.QUARTER_TURN), children: "+90\u00B0" }), jsxRuntime.jsx("button", { onClick: () => handleFlip('X'), children: "\u21C4" }), jsxRuntime.jsx("button", { onClick: () => handleFlip('Y'), children: "\u21C5" }), jsxRuntime.jsxs("div", { className: "dk-image-editor__size-inputs", children: [jsxRuntime.jsx("input", { type: "number", value: cropWidth, onChange: (e) => handleWidthChange(e.target.value), min: "1", placeholder: "W" }), jsxRuntime.jsx("button", { className: `dk-image-editor__lock-btn ${isAspectLocked ? 'locked' : ''}`, onClick: () => setIsAspectLocked(!isAspectLocked), title: isAspectLocked ? t('crop.unlock.ratio') : t('crop.lock.ratio'), children: isAspectLocked ? jsxRuntime.jsx(IconLock, { size: 14 }) : jsxRuntime.jsx(IconUnlock, { size: 14 }) }), jsxRuntime.jsx("input", { type: "number", value: cropHeight, onChange: (e) => handleHeightChange(e.target.value), min: "1", placeholder: "H" })] })] }), jsxRuntime.jsxs("div", { className: "dk-image-editor__rotation-controls", children: [jsxRuntime.jsxs("div", { className: "dk-image-editor__slider", children: [jsxRuntime.jsx("label", { children: t('crop.rotation') }), jsxRuntime.jsx("input", { type: "range", min: "-180", max: "180", value: editorState.rotation || 0, onChange: (e) => onStateChange({ rotation: Number(e.target.value) }) }), jsxRuntime.jsxs("span", { children: [editorState?.rotation || 0, "\u00B0"] })] }), jsxRuntime.jsxs("div", { className: "dk-image-editor__slider", children: [jsxRuntime.jsx("label", { children: t('crop.scale') }), jsxRuntime.jsx("input", { type: "range", min: "0.1", max: "3", step: "0.1", value: editorState.scale || 1, onChange: (e) => onStateChange({ scale: Number(e.target.value) }) }), jsxRuntime.jsxs("span", { children: [(editorState?.scale || 1).toFixed(1), "x"] })] }), jsxRuntime.jsxs("div", { className: "dk-image-editor__slider", children: [jsxRuntime.jsx("label", { children: t('crop.skew') }), jsxRuntime.jsx("input", { type: "range", min: "0", max: "360", step: "5", value: (() => {
...
function IconAnnotate(props) {
    const width = props.size || props.width || 20;
    const height = props.size || props.height || 20;
    return (jsxRuntime.jsx("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: jsxRuntime.jsx("path", { d: "M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" }) }));
}

function IconCrop(props) {
    const width = props.size || props.width || 20;
    const height = props.size || props.height || 20;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [jsxRuntime.jsx("path", { d: "M6.13 1L6 16a2 2 0 002 2h15" }), jsxRuntime.jsx("path", { d: "M1 6.13L16 6a2 2 0 012 2v15" })] }));
}

function IconFilter(props) {
    const width = props.size || props.width || 20;
    const height = props.size || props.height || 20;
    return (jsxRuntime.jsx("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: jsxRuntime.jsx("path", { d: "M18.347 9.907a6.5 6.5 0 1 0-1.872 3.306M3.26 11.574a6.5 6.5 0 1 0 2.815-1.417 M10.15 17.897A6.503 6.503 0 0 0 16.5 23a6.5 6.5 0 1 0-6.183-8.51" }) }));
}

function IconFinetune(props) {
    const width = props.size || props.width || 20;
    const height = props.size || props.height || 20;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [jsxRuntime.jsx("line", { x1: "4", y1: "21", x2: "4", y2: "14" }), jsxRuntime.jsx("line", { x1: "4", y1: "10", x2: "4", y2: "3" }), jsxRuntime.jsx("line", { x1: "12", y1: "21", x2: "12", y2: "12" }), jsxRuntime.jsx("line", { x1: "12", y1: "8", x2: "12", y2: "3" }), jsxRuntime.jsx("line", { x1: "20", y1: "21", x2: "20", y2: "16" }), jsxRuntime.jsx("line", { x1: "20", y1: "12", x2: "20", y2: "3" }), jsxRuntime.jsx("line", { x1: "1", y1: "14", x2: "7", y2: "14" }), jsxRuntime.jsx("line", { x1: "9", y1: "8", x2: "15", y2: "8" }), jsxRuntime.jsx("line", { x1: "17", y1: "16", x2: "23", y2: "16" })] }));
}

const IconFrame = ({ size = 16, className = '' }) => {
    return (jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: className, children: [jsxRuntime.jsx("rect", { x: "3", y: "3", width: "18", height: "18", rx: "2", ry: "2" }), jsxRuntime.jsx("rect", { x: "7", y: "7", width: "10", height: "10" })] }));
};

function IconSelect(props) {
    const width = props.size || props.width || 20;
    const height = props.size || props.height || 20;
    return (jsxRuntime.jsx("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: jsxRuntime.jsx("path", { d: "M3 3l7.07 16.97 2.51-7.39 7.39-2.51L3 3z" }) }));
}

function IconSticker(props) {
    const width = props.size || props.width || 20;
    const height = props.size || props.height || 20;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 1024 1024", fill: "currentColor", children: [jsxRuntime.jsx("path", { d: "M670.64 403.2c-5.04-18.776-14.808-34.984-27.056-45.696-12.16-10.712-27.904-16.856-43.816-12.584-15.872 4.264-26.456 17.448-31.576 32.768-5.248 15.44-5.632 34.304-0.6 53.16 5.04 18.776 14.808 34.984 27.056 45.696 12.16 10.712 27.904 16.856 43.776 12.584 15.92-4.264 26.448-17.408 31.656-32.768 5.2-15.44 5.592-34.304 0.56-53.12V403.2z m-247.384 66.264c-4.992-18.776-14.768-34.992-27.008-45.744-12.16-10.664-27.904-16.808-43.776-12.584-15.92 4.264-26.456 17.496-31.664 32.856-5.2 15.4-5.584 34.256-0.552 53.072 5.04 18.816 14.8 34.992 27.048 45.744 12.16 10.664 27.904 16.848 43.776 12.584 15.92-4.264 26.456-17.448 31.664-32.808 5.2-15.408 5.584-34.304 0.56-53.12h-0.048z" }), jsxRuntime.jsx("path", { d: "M512 32C246.912 32 32 246.912 32 512c0 265.088 214.912 480 480 480 42.024 0 78.936-19.376 105.384-45.816l328.8-328.8C972.624 590.984 992 554.024 992 512c0-265.088-214.912-480-480-480zM119.28 512a392.872 392.872 0 0 1 43.104-179.192 395.456 395.456 0 0 1 28.864-47.712 394 394 0 0 1 48.424-56.352A392.616 392.616 0 0 1 416.688 130.72a393.344 393.344 0 0 1 110.656-11.44 391.096 391.096 0 0 1 55.424 6.128 392.736 392.736 0 0 1 319.56 342.944c-91.072 0.224-150.2 2.096-200.16 19.6a350.928 350.928 0 0 0-43.248 18.48 355.96 355.96 0 0 0-20.592 11.376 352.52 352.52 0 0 0-32.464 21.968 359.096 359.096 0 0 0-18.224 14.88 354.48 354.48 0 0 0-22.664 21.68 354.992 354.992 0 0 0-20.624 23.64 352.992 352.992 0 0 0-18.416 25.384 355.52 355.52 0 0 0-12.28 20.072 310.4 310.4 0 0 1-55.176 4.544 307.424 307.424 0 0 1-39.464-2.816 308.056 308.056 0 0 1-31.12-5.872 44.656 44.656 0 0 0-8.488-1.32 44.784 44.784 0 0 0-8.584 0.368 45.48 45.48 0 0 0-6.304 1.384 43.888 43.888 0 0 0-13.408 6.688 45.064 45.064 0 0 0-4.896 4.2 44.728 44.728 0 0 0-5.464 6.632 44.032 44.032 0 0 0-5.52 11.624 45.416 45.416 0 0 0-1.408 6.288 46.728 46.728 0 0 0-0.416 4.28 43.848 43.848 0 0 0 2.536 16.912 43.48 43.48 0 0 0 15.24 20.384 43.792 43.792 0 0 0 15.504 7.216c35.352 8.856 73.096 12.648 111.84 10.816-8.768 42.896-9.992 94.472-10.12 165.56C272 880.64 119.272 714.168 119.272 512z m611.68 58.344c32.432-11.352 72.44-13.968 153.392-14.576l-328.584 328.584c0.56-80.952 3.224-120.96 14.576-153.384a261.104 261.104 0 0 1 21.616-46.544 267.28 267.28 0 0 1 11.976-18.48 268.08 268.08 0 0 1 13.488-17.4 268.664 268.664 0 0 1 14.904-16.216 266.92 266.92 0 0 1 16.208-14.904 261.096 261.096 0 0 1 48.744-32.568 268.624 268.624 0 0 1 19.968-9.28 259.544 259.544 0 0 1 13.72-5.232z" })] }));
}

const TOOL_MAP = {
    select: { name: 'Select', icon: jsxRuntime.jsx(IconSelect, {}) },
    crop: { name: 'Crop', icon: jsxRuntime.jsx(IconCrop, {}) },
    finetune: { name: 'Finetune', icon: jsxRuntime.jsx(IconFinetune, {}) },
    filter: { name: 'Filter', icon: jsxRuntime.jsx(IconFilter, {}) },
    annotate: { name: 'Annotate', icon: jsxRuntime.jsx(IconAnnotate, {}) },
    sticker: { name: 'Sticker', icon: jsxRuntime.jsx(IconSticker, {}) },
    frame: { name: 'Frame', icon: jsxRuntime.jsx(IconFrame, {}) },
...
const IconBrightness = ({ size = 16, color = 'currentColor' }) => {
    return (jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("circle", { cx: "12", cy: "12", r: "4", fill: color }), jsxRuntime.jsx("path", { d: "M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41", stroke: color, strokeWidth: "2", strokeLinecap: "round" })] }));
};

const IconContrast = ({ size = 16, color = 'currentColor' }) => {
    return (jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("circle", { cx: "12", cy: "12", r: "9", stroke: color, strokeWidth: "2" }), jsxRuntime.jsx("path", { d: "M12 3a9 9 0 0 1 0 18z", fill: color })] }));
};

const IconExposure = ({ size = 16, color = 'currentColor' }) => {
    return (jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("circle", { cx: "12", cy: "12", r: "9", stroke: color, strokeWidth: "2" }), jsxRuntime.jsx("path", { d: "M8 8h8M8 12h8M8 16h4", stroke: color, strokeWidth: "2", strokeLinecap: "round" }), jsxRuntime.jsx("path", { d: "M16 16l2-2M18 18l-2-2", stroke: color, strokeWidth: "2", strokeLinecap: "round" })] }));
};

const IconGamma = ({ size = 16, color = 'currentColor' }) => {
    return (jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("path", { d: "M3 21h18l-9-18z", stroke: color, strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }), jsxRuntime.jsx("path", { d: "M12 3v18", stroke: color, strokeWidth: "2", strokeLinecap: "round" }), jsxRuntime.jsx("path", { d: "M7.5 15h9", stroke: color, strokeWidth: "2", strokeLinecap: "round" })] }));
};

const IconSaturation = ({ size = 16, color = 'currentColor' }) => {
    return (jsxRuntime.jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { d: "M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z", fill: color }) }));
};

const IconVignette = ({ size = 16, color = 'currentColor' }) => {
    return (jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("rect", { x: "3", y: "3", width: "18", height: "18", rx: "2", stroke: color, strokeWidth: "2" }), jsxRuntime.jsx("circle", { cx: "12", cy: "12", r: "6", fill: "none", stroke: color, strokeWidth: "2", strokeDasharray: "2 2" }), jsxRuntime.jsx("circle", { cx: "12", cy: "12", r: "3", fill: color })] }));
};
...
const FinetunePanel = ({ editorState, selectedFinetuneOption, finetuneOptions, editorRef, onStateChange, setSelectedFinetuneOption, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: "dk-image-editor__finetune-controls", children: [jsxRuntime.jsxs("div", { className: "dk-image-editor__slider", children: [jsxRuntime.jsx("label", { children: currentLabel }), jsxRuntime.jsx("input", { type: "range", min: SLIDER_RANGES.FINETUNE.min, max: SLIDER_RANGES.FINETUNE.max, value: currentValue, onChange: (e) => handleSliderChange(Number(e.target.value)) }), jsxRuntime.jsx("span", { children: currentValue })] }), jsxRuntime.jsxs("div", { className: "dk-image-editor__finetune-options", children: [jsxRuntime.jsx("button", { className: "dk-image-editor__finetune-option", onClick: handleReset, title: t('finetune.reset'), children: jsxRuntime.jsx(IconReset, { size: 14 }) }), finetuneOptions.map(([key, label]) => {
                        const getIcon = () => {
                            switch (key) {
                                case 'brightness':
                                    return jsxRuntime.jsx(IconBrightness, { size: 14 });
                                case 'contrast':
                                    return jsxRuntime.jsx(IconContrast, { size: 14 });
                                case 'saturation':
                                    return jsxRuntime.jsx(IconSaturation, { size: 14 });
                                case 'exposure':
                                    return jsxRuntime.jsx(IconExposure, { size: 14 });
                                case 'gamma':
                                    return jsxRuntime.jsx(IconGamma, { size: 14 });
                                case 'vignette':
                                    return jsxRuntime.jsx(IconVignette, { size: 14 });
                                default:
                                    return FINETUNE_SHORTCUTS[key] || key.substring(0, 2).toUpperCase();
                            }
                        };
                        return (jsxRuntime.jsx("button", { className: `dk-image-editor__finetune-option ${selectedFinetuneOption === key ? 'dk-image-editor__finetune-option--active' : ''}`, onClick: () => setSelectedFinetuneOption(key), title: t(`finetune.${key}`), children: getIcon() }, key));
                    })] })] }));
};

const IconArrow = ({ size = 16, width, height, style }) => {
    return (jsxRuntime.jsxs("svg", { width: width || size, height: height || size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", style: style, children: [jsxRuntime.jsx("line", { x1: "7", y1: "17", x2: "17", y2: "7" }), jsxRuntime.jsx("polyline", { points: "7,7 17,7 17,17" })] }));
};

const IconDraw = ({ size = 16, width, height, style }) => {
    return (jsxRuntime.jsx("svg", { width: width || size, height: height || size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", style: style, children: jsxRuntime.jsx("path", { d: "M3 17c3-3 6-6 9-3s6 6 9 3" }) }));
};

const IconEllipse = ({ size = 16, width, height, style }) => {
    return (jsxRuntime.jsx("svg", { width: width || size, height: height || size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", style: style, children: jsxRuntime.jsx("circle", { cx: "12", cy: "12", r: "10" }) }));
};

const IconLine = ({ size = 16, width, height, style }) => {
    return (jsxRuntime.jsx("svg", { width: width || size, height: height || size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", style: style, children: jsxRuntime.jsx("line", { x1: "7", y1: "17", x2: "17", y2: "7" }) }));
};

const IconRectangle = ({ size = 16, width, height, style }) => {
    return (jsxRuntime.jsx("svg", { width: width || size, height: height || size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", style: style, children: jsxRuntime.jsx("rect", { x: "3", y: "3", width: "18", height: "18", rx: "2", ry: "2" }) }));
};

const IconText = ({ size = 16, width, height, style }) => {
    return (jsxRuntime.jsxs("svg", { width: width || size, height: height || size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", style: style, children: [jsxRuntime.jsx("polyline", { points: "4,7 4,4 20,4 20,7" }), jsxRuntime.jsx("line", { x1: "9", y1: "20", x2: "15", y2: "20" }), jsxRuntime.jsx("line", { x1: "12", y1: "4", x2: "12", y2: "20" })] }));
};
...
const ColorPicker = React.memo(({ value, onChange, title }) => {
    const handleColorPickerClick = React.useCallback((e) => {
        e.preventDefault();
    ...
    return (jsxRuntime.jsx("button", { className: "dk-image-editor__color-button", onClick: handleColorPickerClick, children: jsxRuntime.jsx("div", { className: "dk-image-editor__color-picker", children: jsxRuntime.jsx("input", { type: "color", value: value, onChange: handleColorChange, title: title, onClick: (e) => {
...
const AnnotatePanel = ({ currentAnnotation, lastAnnotateColor, annotateTools, setCurrentAnnotation, setLastAnnotateColor, }) => {
    ...
    const handleStrokeWidthChange = React.useCallback((width) => {
    ...
    const FontSizeSlider = currentAnnotation?.type === 'text' ? (jsxRuntime.jsxs("div", { className: "dk-image-editor__compact-slider", children: [jsxRuntime.jsxs("label", { children: [t('annotate.size'), ":"] }), jsxRuntime.jsx("input", { type: "range", min: SLIDER_RANGES.FONT_SIZE.min, max: SLIDER_RANGES.FONT_SIZE.max, value: currentAnnotation.fontSize || DEFAULT_FONT_SIZE, onChange: (e) => handleFontSizeChange(Number(e.target.value)) }), jsxRuntime.jsx("span", { children: currentAnnotation.fontSize || DEFAULT_FONT_SIZE })] })) : null;
    const FillColorPicker = currentAnnotation?.type === 'rectangle' || currentAnnotation?.type === 'ellipse' ? (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { className: "dk-image-editor__color-box", children: [jsxRuntime.jsxs("label", { children: [t('annotate.fill'), ": "] }), jsxRuntime.jsx(ColorPicker, { value: currentAnnotation.fillColor || '#000000', onChange: handleFillColorChange, title: "Fill Color" }), currentAnnotation.fillColor && currentAnnotation.fillColor !== 'transparent' && (jsxRuntime.jsx("button", { onClick: () => handleFillColorChange('transparent'), className: "dk-image-editor__clear-fill", title: t('annotate.clear.fill'), children: "\u2715" }))] }) })) : null;
    return (jsxRuntime.jsxs("div", { className: "dk-image-editor__annotate-controls", children: [jsxRuntime.jsxs("div", { className: "dk-image-editor__annotate-settings", children: [currentAnnotation?.type === 'text' ? (jsxRuntime.jsxs("div", { className: "dk-image-editor__color-box", children: [jsxRuntime.jsxs("label", { children: [t('annotate.color'), ": "] }), jsxRuntime.jsx(ColorPicker, { value: lastAnnotateColor, onChange: handleColorChange, title: t('toolbar.text.color') })] })) : (jsxRuntime.jsxs("div", { className: "dk-image-editor__color-box", children: [jsxRuntime.jsxs("label", { children: [t('annotate.stroke'), ": "] }), jsxRuntime.jsx(ColorPicker, { value: currentAnnotation?.strokeColor || lastAnnotateColor, onChange: handleStrokeColorChange, title: t('toolbar.stroke.color') })] })), FillColorPicker, currentAnnotation?.type !== 'text' && (jsxRuntime.jsxs("div", { className: "dk-image-editor__compact-slider", children: [jsxRuntime.jsxs("label", { children: [t('annotate.width'), ":"] }), jsxRuntime.jsx("input", { type: "range", min: SLIDER_RANGES.STROKE_WIDTH.min, max: SLIDER_RANGES.STROKE_WIDTH.max, value: currentAnnotation?.strokeWidth || DEFAULT_STROKE_WIDTH, onChange: (e) => handleStrokeWidthChange(Number(e.target.value)) }), jsxRuntime.jsx("span", { children: currentAnnotation?.strokeWidth || DEFAULT_STROKE_WIDTH })] })), FontSizeSlider] }), jsxRuntime.jsx("div", { className: "dk-image-editor__toolbar", children: annotateTools.map(([tool, name]) => {
                    const getIcon = () => {
                        switch (tool) {
                            case 'sharpie':
                                return jsxRuntime.jsx(IconDraw, { size: 16 });
                            case 'line':
                                return jsxRuntime.jsx(IconLine, { size: 16 });
                            case 'arrow':
                                return jsxRuntime.jsx(IconArrow, { size: 16 });
                            case 'rectangle':
                                return jsxRuntime.jsx(IconRectangle, { size: 16 });
                            case 'ellipse':
                                return jsxRuntime.jsx(IconEllipse, { size: 16 });
                            case 'text':
                                return jsxRuntime.jsx(IconText, { size: 16 });
                            default:
                                return null;
                        }
                    };
                    return (jsxRuntime.jsxs("button", { onClick: () => handleToolSelect(tool), className: `dk-image-editor__tool-button ${currentAnnotation?.type === tool ? 'dk-image-editor__unified-button--active' : ''}`, children: [getIcon(), t(`annotate.${tool}`)] }, tool));
                }) })] }));
};
...
const StickerPanel = ({ editorRef, stickerPluginRef, selectionPluginRef, imagePluginRef, zoomLevel, setHasSelection, currentSticker, setCurrentSticker, }) => {
    ...
    const [loadingStickers, setLoadingStickers] = React.useState(new Set());
    const stickerImages = React.useMemo(() => [
    ...
    const handleStickerSelect = React.useCallback((content, type = 'emoji') => {
        setCurrentSticker({ content, type });
    }, [setCurrentSticker]);
    return (jsxRuntime.jsxs("div", { className: "dk-image-editor__sticker-controls", children: [jsxRuntime.jsx("div", { className: "d-flex align-items-center gap-2", children: Object.keys(categories).map((category) => {
                    const getIcon = () => {
                        const categoryItems = categories[category];
                        if (category === 'stickers') {
                            const firstItem = categoryItems[0];
                            return firstItem ? jsxRuntime.jsx("img", { src: firstItem, alt: "sticker", style: { width: '16px', height: '16px' } }) : null;
                        }
                        const firstItem = categoryItems[0];
                        return firstItem ? jsxRuntime.jsx("span", { style: { fontSize: '16px' }, children: firstItem }) : null;
                    };
                    return (jsxRuntime.jsxs("button", { className: `dk-image-editor__tool-button ${selectedCategory === category ? 'active' : ''}`, onClick: () => {
                ...
                }) }), jsxRuntime.jsxs("div", { className: "dk-image-editor__toolbar", children: [jsxRuntime.jsxs("label", { className: "dk-image-editor__upload-button", children: [jsxRuntime.jsx("input", { type: "file", accept: "image/*", style: { display: 'none' }, onChange: (e) => {
                                    const file = e.target.files?.[0];
                                    if (file)
                                        handleFileUpload(file);
                                } }), jsxRuntime.jsx("span", { className: "dk-image-editor__upload-icon", children: "+" }), jsxRuntime.jsx("span", { className: "dk-image-editor__upload-text", children: t('sticker.upload') })] }), categories[selectedCategory].map((item, index) => {
                        const isSelected = currentSticker?.content === item;
                        return (jsxRuntime.jsx("button", { onClick: () => handleStickerSelect(item, selectedCategory === 'stickers' ? 'image' : 'emoji'), className: classNames('dk-image-editor__tool-button', {
                                'css-loading': loadingStickers.has(item),
                                'dk-image-editor__unified-button--active': isSelected,
                            }), style: { height: selectedCategory === 'stickers' ? 'auto' : '' }, children: selectedCategory === 'stickers' ? (jsxRuntime.jsx("img", { src: item, alt: "sticker", style: { width: '32px', height: '32px' } })) : (jsxRuntime.jsx("span", { style: { fontSize: '24px' }, children: item })) }, typeof item === 'string' ? item : index));
                    })] })] }));
};
...
const FILTER_PREVIEWS = {
    chrome: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "#FFFFFF", rx: "8" }), jsxRuntime.jsx("rect", { x: "6", y: "8", width: "28", height: "12", fill: "#1966FF", rx: "2" }), jsxRuntime.jsx("rect", { x: "10", y: "16", width: "24", height: "16", fill: "#00C87F", rx: "2" }), jsxRuntime.jsx("text", { x: "20", y: "26", textAnchor: "middle", fill: "#FFFFFF", fontSize: "8", fontWeight: "bold", children: "HD" })] })),
    fade: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("linearGradient", { id: "fade-grad", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#333333", stopOpacity: "1" }), jsxRuntime.jsx("stop", { offset: "50%", stopColor: "#666666", stopOpacity: "0.6" }), jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#cccccc", stopOpacity: "0.2" })] }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "#f5f5f5", rx: "6" }), jsxRuntime.jsx("rect", { x: "5", y: "15", width: "30", height: "10", fill: "url(#fade-grad)", rx: "2" })] })),
    cold: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("linearGradient", { id: "cold-grad", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#e6f7ff" }), jsxRuntime.jsx("stop", { offset: "50%", stopColor: "#91d5ff" }), jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#40a9ff" })] }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "url(#cold-grad)", rx: "4" }), jsxRuntime.jsx("path", { d: "M20 8 L24 16 L20 24 L16 16 Z", fill: "#fff", opacity: "0.7" }), jsxRuntime.jsx("path", { d: "M8 20 L16 24 L24 20 L16 16 Z", fill: "#fff", opacity: "0.5" })] })),
    warm: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("radialGradient", { id: "warm-grad", children: [jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#fff7e6" }), jsxRuntime.jsx("stop", { offset: "50%", stopColor: "#ffd591" }), jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#fa8c16" })] }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "url(#warm-grad)", rx: "4" }), jsxRuntime.jsx("circle", { cx: "20", cy: "15", r: "6", fill: "#ffec3d", opacity: "0.8" }), jsxRuntime.jsx("path", { d: "M20 21 Q15 25 10 30 Q20 28 20 21", fill: "#ff7a45", opacity: "0.6" }), jsxRuntime.jsx("path", { d: "M20 21 Q25 25 30 30 Q20 28 20 21", fill: "#ff7a45", opacity: "0.6" })] })),
    monoDefault: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "#f0f0f0" }), jsxRuntime.jsx("rect", { width: "20", height: "40", fill: "#333" }), jsxRuntime.jsx("rect", { x: "10", y: "10", width: "20", height: "20", fill: "#666" }), jsxRuntime.jsx("rect", { x: "15", y: "15", width: "10", height: "10", fill: "#999" })] })),
    sepiaDefault: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("linearGradient", { id: "sepia-grad", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#f4e4bc" }), jsxRuntime.jsx("stop", { offset: "50%", stopColor: "#d2b48c" }), jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#8b7355" })] }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "url(#sepia-grad)", rx: "4" }), jsxRuntime.jsx("circle", { cx: "12", cy: "12", r: "4", fill: "#deb887", opacity: "0.8" }), jsxRuntime.jsx("circle", { cx: "28", cy: "28", r: "6", fill: "#cd853f", opacity: "0.6" })] })),
    blur: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsx("filter", { id: "blur-effect", children: jsxRuntime.jsx("feGaussianBlur", { in: "SourceGraphic", stdDeviation: "2" }) }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "#f0f8ff" }), jsxRuntime.jsx("circle", { cx: "15", cy: "15", r: "8", fill: "#4169e1", filter: "url(#blur-effect)", opacity: "0.7" }), jsxRuntime.jsx("circle", { cx: "25", cy: "25", r: "6", fill: "#1e90ff", filter: "url(#blur-effect)", opacity: "0.5" })] })),
    sharpen: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "#fafafa" }), jsxRuntime.jsx("polygon", { points: "20,5 30,20 20,35 10,20", fill: "#ff4d4f", stroke: "#fff", strokeWidth: "2" }), jsxRuntime.jsx("polygon", { points: "20,10 25,20 20,30 15,20", fill: "#fff", opacity: "0.8" })] })),
    emboss: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("linearGradient", { id: "emboss-grad", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#ffffff" }), jsxRuntime.jsx("stop", { offset: "50%", stopColor: "#cccccc" }), jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#666666" })] }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "#e8e8e8" }), jsxRuntime.jsx("rect", { x: "8", y: "8", width: "24", height: "24", fill: "url(#emboss-grad)", rx: "2" }), jsxRuntime.jsx("rect", { x: "10", y: "10", width: "20", height: "20", fill: "none", stroke: "#999", strokeWidth: "1" })] })),
    oil: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "#2c3e50" }), jsxRuntime.jsx("circle", { cx: "12", cy: "15", r: "5", fill: "#e74c3c", opacity: "0.8" }), jsxRuntime.jsx("circle", { cx: "28", cy: "12", r: "4", fill: "#f39c12", opacity: "0.7" }), jsxRuntime.jsx("circle", { cx: "25", cy: "28", r: "6", fill: "#3498db", opacity: "0.6" }), jsxRuntime.jsx("circle", { cx: "15", cy: "30", r: "3", fill: "#2ecc71", opacity: "0.9" }), jsxRuntime.jsx("path", { d: "M10 25 Q20 20 30 25 Q25 30 15 28", fill: "#9b59b6", opacity: "0.5" })] })),
    vintage: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("radialGradient", { id: "vintage-grad", children: [jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#f5e6d3" }), jsxRuntime.jsx("stop", { offset: "70%", stopColor: "#d4a574" }), jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#8b6914" })] }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "url(#vintage-grad)", rx: "6" }), jsxRuntime.jsx("circle", { cx: "20", cy: "20", r: "12", fill: "none", stroke: "#8b6914", strokeWidth: "2", opacity: "0.6" }), jsxRuntime.jsx("rect", { x: "16", y: "8", width: "8", height: "4", fill: "#8b6914", opacity: "0.8" })] })),
    dramatic: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("linearGradient", { id: "dramatic-grad", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#000000" }), jsxRuntime.jsx("stop", { offset: "50%", stopColor: "#666666" }), jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#ffffff" })] }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "url(#dramatic-grad)" }), jsxRuntime.jsx("polygon", { points: "20,8 28,20 20,32 12,20", fill: "#fff", opacity: "0.3" })] })),
    vivid: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("radialGradient", { id: "vivid-grad", children: [jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#ff6b6b" }), jsxRuntime.jsx("stop", { offset: "33%", stopColor: "#4ecdc4" }), jsxRuntime.jsx("stop", { offset: "66%", stopColor: "#45b7d1" }), jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#96ceb4" })] }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "url(#vivid-grad)", rx: "8" }), jsxRuntime.jsx("circle", { cx: "15", cy: "15", r: "4", fill: "#fff", opacity: "0.4" }), jsxRuntime.jsx("circle", { cx: "25", cy: "25", r: "3", fill: "#fff", opacity: "0.6" })] })),
    noir: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "#1a1a1a" }), jsxRuntime.jsx("rect", { x: "5", y: "15", width: "30", height: "2", fill: "#ffffff" }), jsxRuntime.jsx("rect", { x: "5", y: "23", width: "30", height: "2", fill: "#cccccc" }), jsxRuntime.jsx("circle", { cx: "12", cy: "12", r: "3", fill: "#ffffff" }), jsxRuntime.jsx("circle", { cx: "28", cy: "28", r: "4", fill: "#888888" }), jsxRuntime.jsx("rect", { x: "18", y: "18", width: "4", height: "4", fill: "#ffffff" })] })),
    sunset: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("linearGradient", { id: "sunset-grad", x1: "0%", y1: "0%", x2: "0%", y2: "100%", children: [jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#ff9a56" }), jsxRuntime.jsx("stop", { offset: "50%", stopColor: "#ff6b35" }), jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#f7931e" })] }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "url(#sunset-grad)", rx: "4" }), jsxRuntime.jsx("circle", { cx: "20", cy: "12", r: "6", fill: "#fff59d", opacity: "0.9" }), jsxRuntime.jsx("ellipse", { cx: "20", cy: "32", rx: "15", ry: "4", fill: "#ff5722", opacity: "0.6" }), jsxRuntime.jsx("path", { d: "M5 25 Q20 20 35 25", stroke: "#ffcc02", strokeWidth: "2", fill: "none", opacity: "0.8" })] })),
    ocean: (jsxRuntime.jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", children: [jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("linearGradient", { id: "ocean-grad", x1: "0%", y1: "0%", x2: "0%", y2: "100%", children: [jsxRuntime.jsx("stop", { offset: "0%", stopColor: "#87ceeb" }), jsxRuntime.jsx("stop", { offset: "50%", stopColor: "#4682b4" }), jsxRuntime.jsx("stop", { offset: "100%", stopColor: "#191970" })] }) }), jsxRuntime.jsx("rect", { width: "40", height: "40", fill: "url(#ocean-grad)", rx: "4" }), jsxRuntime.jsx("path", { d: "M0 30 Q10 25 20 30 T40 30 V40 H0 Z", fill: "#1e88e5", opacity: "0.7" }), jsxRuntime.jsx("path", { d: "M0 35 Q15 32 30 35 T40 35 V40 H0 Z", fill: "#0d47a1", opacity: "0.5" }), jsxRuntime.jsx("circle", { cx: "30", cy: "10", r: "2", fill: "#ffffff", opacity: "0.8" })] })),
};
const FilterPreview = ({ filterId, name, isActive, onClick, isLoading = false, filterType = 'toggle', clickCount, }) => {
    return (jsxRuntime.jsxs("button", { className: classNames('dk-image-editor__filter-preview', `dk-image-editor__filter-preview--${filterType}`, {
            'dk-image-editor__unified-button--active': isActive,
            'dk-image-editor__filter-preview--loading': isLoading,
            'css-loading': isLoading,
        }), onClick: onClick, disabled: isLoading, children: [jsxRuntime.jsx("div", { className: 'dk-image-editor__filter-icon', children: FILTER_PREVIEWS[filterId] || (jsxRuntime.jsx("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', fontSize: '24px' }, children: "\uD83C\uDFA8" })) }), jsxRuntime.jsxs("span", { className: "dk-image-editor__filter-name", children: [name, filterType === 'apply' && clickCount !== undefined && clickCount > 0 && jsxRuntime.jsx("span", { className: "dk-filter-count", children: clickCount })] })] }));
};
...
const FilterPanel = ({ editorState, filters, editorRef, filterCounts, onStateChange, setFilterCounts, applyAdvancedFilter, }) => {
    ...
    const resetToOriginal = React.useCallback((filter) => {
    ...
    // 应用自定义滤镜
    const applyCustomFilter = React.useCallback((imageData, filterId) => {
        switch (filterId) {
            case 'vintage':
    ...
    // 重新应用所有滤镜
    const reapplyAllFilters = React.useCallback(async (excludeFilterId) => {
    ...
    const handleToggleFilter = React.useCallback((filterId) => {
    ...
    const handleApplyFilter = React.useCallback(async (filter) => {
    ...
    const handleFilterClick = React.useCallback(async (filter) => {
    ...
    return (jsxRuntime.jsxs("div", { className: "dk-image-editor__filter-controls", children: [jsxRuntime.jsxs("div", { className: "d-flex align-items-center gap-2 mb-2", children: [(editorState?.filter || Object.values(filterCounts).some((count) => count > 0)) && (jsxRuntime.jsx("button", { className: "dk-image-editor__tool-button", onClick: handleResetClick, children: jsxRuntime.jsx(IconReset, { size: 14 }) })), jsxRuntime.jsx("button", { className: `dk-image-editor__tool-button ${selectedCategory === 'basic' ? 'active' : ''}`, onClick: () => setSelectedCategory('basic'), children: t('filter.basic') }), jsxRuntime.jsx("button", { className: `dk-image-editor__tool-button ${selectedCategory === 'artistic' ? 'active' : ''}`, onClick: () => setSelectedCategory('artistic'), children: t('filter.artistic') }), jsxRuntime.jsx("button", { className: `dk-image-editor__tool-button ${selectedCategory === 'enhance' ? 'active' : ''}`, onClick: () => setSelectedCategory('enhance'), children: t('filter.enhance') })] }), jsxRuntime.jsx("div", { className: "dk-image-editor__toolbar", children: getCurrentFilters().map((filter) => {
                    const isToggleFilter = toggleFilters.includes(filter.id);
                    const isApplyFilter = applyFilters.includes(filter.id);
                    return (jsxRuntime.jsx(FilterPreview, { filterId: filter.id, name: filter.name, isActive: isToggleFilter && editorState?.filter === filter.id, onClick: () => handleFilterClick(filter), isLoading: isLoading === filter.id, filterType: isApplyFilter ? 'apply' : 'toggle', clickCount: isApplyFilter ? filterCounts[filter.id] || 0 : undefined }, filter.id));
                }) })] }));
};
...
const FramePanel = ({ editorState, editorRef, onStateChange }) => {
    ...
    const FRAME_OPTIONS = DEFAULT_FRAME_OPTIONS.map(([id]) => ({
        id,
        name: t(`frame.${id}`),
        svg: id === 'none' ? null : id === 'solidSharp' ? (jsxRuntime.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%", strokeWidth: "1", stroke: "currentColor", fill: "none", children: jsxRuntime.jsx("rect", { strokeWidth: "5", x: "0", y: "0", width: "100%", height: "100%" }) })) : id === 'solidRound' ? (jsxRuntime.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%", strokeWidth: "1", stroke: "currentColor", fill: "none", children: jsxRuntime.jsx("rect", { strokeWidth: "5", x: "0", y: "0", width: "100%", height: "100%", rx: "12%" }) })) : id === 'lineSingle' ? (jsxRuntime.jsx("div", { style: { inset: '0.5em', boxShadow: 'currentcolor 0px 0px 0px 1px inset' } })) : id === 'lineMultiple' ? (jsxRuntime.jsx("div", { style: { border: '3px double #eee' } })) : id === 'edgeCross' ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { style: {
                        inset: '-0.5em 0.5em',
                        ...
                        width: 'initial',
                        height: 'initial',
                    } })] })) : id === 'edgeSeparate' ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { style: {
                        height: 'initial',
                        width: 'initial',
                        position: 'absolute',
                        top: '0.75em',
                    ...
                    } })] })) : id === 'edgeOverlap' ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { style: {
                        height: 'initial',
                        width: 'initial',
                        position: 'absolute',
                        top: '0.3125em',
                        ...
                        right: '0.3125em',
                        borderBottom: '1px solid',
                    } })] })) : id === 'hook' ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { style: {
                        position: 'absolute',
                        top: '0.5em',
                        left: '0.5em',
                        width: '0.75em',
                        ...
                        borderRight: '1px solid',
                        borderBottom: '1px solid',
                    } })] })) : id === 'polaroid' ? (jsxRuntime.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%", strokeWidth: "1", stroke: "currentColor", fill: "none", children: jsxRuntime.jsx("rect", { strokeWidth: "20%", x: "-5%", y: "-5%", width: "110%", height: "96%" }) })) : null,
    }));
    const handleFrameSelect = React.useCallback((frameId) => {
    ...
    return (jsxRuntime.jsx("div", { className: "dk-image-editor__frame-controls", children: jsxRuntime.jsx("div", { className: "dk-image-editor__frame-list", children: FRAME_OPTIONS.map((frame) => (jsxRuntime.jsxs("div", { className: `dk-image-editor__frame-option ${editorState?.frame === frame.id ? 'active' : ''}`, onClick: () => handleFrameSelect(frame.id), children: [jsxRuntime.jsx("div", { className: "dk-image-editor__frame-preview", children: frame.svg || jsxRuntime.jsx("span", {}) }), jsxRuntime.jsx("span", { className: "dk-image-editor__frame-name", children: frame.name })] }, frame.id))) }) }));
};
...
const EditorProvider = ({ children }) => {
    ...
    const cropPluginRef = React.useRef(null);
    const filterPluginRef = React.useRef(null);
    const annotatePluginRef = React.useRef(null);
    const stickerPluginRef = React.useRef(null);
    const finetunePluginRef = React.useRef(null);
    const imagePluginRef = React.useRef(null);
    const selectionPluginRef = React.useRef(null);
    const advancedFilterPluginRef = React.useRef(null);
    ...
    const contextValue = React.useMemo(() => ({ state, dispatch, refs }), [state, dispatch, refs]);
    return (jsxRuntime.jsx(EditorContext.Provider, { value: contextValue, children: children }));
};
...
const ControlPanels = ({ cropPresets, filters, annotateTools, finetuneOptions, onStateChange, applyAdvancedFilter, }) => {
    ...
    return !activeTool || activeTool === 'select' ? (jsxRuntime.jsx(jsxRuntime.Fragment, {})) : (jsxRuntime.jsxs("div", { className: "dk-image-editor__controls", children: [activeTool === 'crop' && jsxRuntime.jsx(CropPanel, { ...panelProps, cropPresets: cropPresets }), activeTool === 'finetune' && (jsxRuntime.jsx(FinetunePanel, { ...panelProps, selectedFinetuneOption: selectedFinetuneOption, finetuneOptions: finetuneOptions, setSelectedFinetuneOption: setSelectedFinetuneOption })), activeTool === 'annotate' && (jsxRuntime.jsx(AnnotatePanel, { currentAnnotation: currentAnnotation, lastAnnotateColor: lastAnnotateColor, annotateTools: annotateTools, setCurrentAnnotation: setCurrentAnnotation, setLastAnnotateColor: setLastAnnotateColor })), activeTool === 'sticker' && (jsxRuntime.jsx(StickerPanel, { editorRef: editorRef, stickerPluginRef: stickerPluginRef, selectionPluginRef: selectionPluginRef, imagePluginRef: imagePluginRef, zoomLevel: zoomLevel, setHasSelection: setHasSelection, currentSticker: currentSticker, setCurrentSticker: setCurrentSticker })), activeTool === 'filter' && (jsxRuntime.jsx(FilterPanel, { ...panelProps, filters: filters, filterCounts: filterCounts, setFilterCounts: setFilterCounts, applyAdvancedFilter: applyAdvancedFilter })), activeTool === 'frame' && (jsxRuntime.jsx(FramePanel, { ...panelProps }))] }));
};

function IconBringToFront(props) {
    const width = props.size || props.width || 16;
    const height = props.size || props.height || 16;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [jsxRuntime.jsx("path", { d: "M8 8h8v8H8V8z" }), jsxRuntime.jsx("path", { d: "M4 12V4h8" }), jsxRuntime.jsx("path", { d: "M12 20h8v-8" })] }));
}
...
function IconDelete(props) {
    const width = props.size || props.width || 16;
    const height = props.size || props.height || 16;
    return (jsxRuntime.jsx("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: jsxRuntime.jsx("path", { d: "M3 6h18M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6h14zM10 11v6M14 11v6" }) }));
}

function IconMoveDown(props) {
    const width = props.size || props.width || 16;
    const height = props.size || props.height || 16;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [jsxRuntime.jsx("path", { d: "M7 10l5 5 5-5" }), jsxRuntime.jsx("path", { d: "M12 5v10" })] }));
}

function IconMoveUp(props) {
    const width = props.size || props.width || 16;
    const height = props.size || props.height || 16;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [jsxRuntime.jsx("path", { d: "M7 14l5-5 5 5" }), jsxRuntime.jsx("path", { d: "M12 19V9" })] }));
}

function IconSendToBack(props) {
    const width = props.size || props.width || 16;
    const height = props.size || props.height || 16;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [jsxRuntime.jsx("path", { d: "M8 8h8v8H8V8z", opacity: "0.5" }), jsxRuntime.jsx("path", { d: "M4 4h8v8H4V4z" }), jsxRuntime.jsx("path", { d: "M12 12h8v8h-8v-8z" })] }));
}
...
const FloatingToolbar = ({ visible, editingText, editingTextItem, selectionPluginRef, onDelete, onCopy, onMoveToFront, onMoveToBack, onMoveUp, onMoveDown, onTextItemChange, }) => {
    ...
    if (!visible)
        return null;
    return (jsxRuntime.jsxs("div", { className: "dk-image-editor__floating-toolbar floatingToolbar", children: [jsxRuntime.jsx("button", { onClick: onDelete, className: "dk-image-editor__toolbar-button", title: isMultiSelect ? t('toolbar.delete.multi', { count: selectedCount }) : t('toolbar.delete'), children: jsxRuntime.jsx(IconDelete, {}) }), jsxRuntime.jsx("button", { onClick: onCopy, className: "dk-image-editor__toolbar-button", title: isMultiSelect ? t('toolbar.copy.multi', { count: selectedCount }) : t('toolbar.copy'), children: jsxRuntime.jsx(IconCopy, {}) }), !isMultiSelect && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("button", { onClick: onMoveToFront, className: "dk-image-editor__toolbar-button", title: t('toolbar.front'), children: jsxRuntime.jsx(IconBringToFront, {}) }), jsxRuntime.jsx("button", { onClick: onMoveToBack, className: "dk-image-editor__toolbar-button", title: t('toolbar.back'), children: jsxRuntime.jsx(IconSendToBack, {}) }), jsxRuntime.jsx("button", { onClick: onMoveUp, className: "dk-image-editor__toolbar-button", title: t('toolbar.forward'), children: jsxRuntime.jsx(IconMoveUp, {}) }), jsxRuntime.jsx("button", { onClick: onMoveDown, className: "dk-image-editor__toolbar-button", title: t('toolbar.backward'), children: jsxRuntime.jsx(IconMoveDown, {}) })] })), isMultiSelect && (jsxRuntime.jsx("span", { className: "d-flex align-items-center", style: { color: 'white', fontSize: '12px', padding: '0 8px' }, children: t('toolbar.selected.count', { count: selectedCount }) })), editingText && editingTextItem && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { style: { width: '1px', height: '24px', background: 'rgba(255,255,255,0.3)', margin: '0 4px' } }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.bold'), onClick: () => updateTextItem({ fontWeight: editingTextItem.fontWeight === 'bold' ? 'normal' : 'bold' }), children: jsxRuntime.jsx("strong", { children: "B" }) }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.italic'), onClick: () => updateTextItem({ fontStyle: editingTextItem.fontStyle === 'italic' ? 'normal' : 'italic' }), children: jsxRuntime.jsx("em", { children: "I" }) }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.underline'), onClick: () => updateTextItem({ textDecoration: editingTextItem.textDecoration === 'underline' ? 'none' : 'underline' }), children: jsxRuntime.jsx("u", { children: "U" }) }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.strikethrough'), onClick: () => updateTextItem({ textDecoration: editingTextItem.textDecoration === 'line-through' ? 'none' : 'line-through' }), children: jsxRuntime.jsx("s", { children: "S" }) }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.font.smaller'), onClick: () => updateTextItem({
                        ...
                        }), children: "A-" }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.font.larger'), onClick: () => updateTextItem({
                        ...
                        }), children: "A+" }), jsxRuntime.jsx(ColorPicker, { value: editingTextItem.color || '#000000', onChange: (color) => updateTextItem({ color }), title: t('toolbar.text.color') })] })), isTextSelected && !isMultiSelect && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { style: { width: '1px', height: '24px', background: 'rgba(255,255,255,0.3)', margin: '0 4px' } }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.bold'), onClick: () => updateSelectedTextItem({ fontWeight: selectedItem.fontWeight === 'bold' ? 'normal' : 'bold' }), children: jsxRuntime.jsx("strong", { children: "B" }) }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.italic'), onClick: () => updateSelectedTextItem({ fontStyle: selectedItem.fontStyle === 'italic' ? 'normal' : 'italic' }), children: jsxRuntime.jsx("em", { children: "I" }) }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.underline'), onClick: () => updateSelectedTextItem({ textDecoration: selectedItem.textDecoration === 'underline' ? 'none' : 'underline' }), children: jsxRuntime.jsx("u", { children: "U" }) }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.strikethrough'), onClick: () => updateSelectedTextItem({ textDecoration: selectedItem.textDecoration === 'line-through' ? 'none' : 'line-through' }), children: jsxRuntime.jsx("s", { children: "S" }) }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.font.smaller'), onClick: () => updateSelectedTextItem({
                        ...
                        }), children: "A-" }), jsxRuntime.jsx("button", { className: "dk-image-editor__toolbar-button", title: t('toolbar.font.larger'), onClick: () => updateSelectedTextItem({
                        ...
                        }), children: "A+" }), jsxRuntime.jsx(ColorPicker, { value: selectedItem.color || '#000000', onChange: (color) => updateSelectedTextItem({ color }), title: t('toolbar.text.color') })] })), isGraphicSelected && !isMultiSelect && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { style: { width: '1px', height: '24px', background: 'rgba(255,255,255,0.3)', margin: '0 4px' } }), jsxRuntime.jsx(ColorPicker, { value: selectedItem?.strokeColor || selectedItem?.color || '#000000', onChange: handleStrokeColorChange, title: t('toolbar.stroke.color') }), jsxRuntime.jsx("select", { value: selectedItem?.strokeWidth || 2, onChange: (e) => handleStrokeWidthChange(Number(e.target.value)), style: {
                            background: 'transparent',
                            border: '#ffffff20',
                            borderRadius: '4px',
                            color: 'white',
                            fontSize: '12px',
                        }, title: t('toolbar.stroke.width'), children: [1, 2, 3, 4, 5, 6, 8, 10, 12, 15, 20].map((width) => (jsxRuntime.jsxs("option", { value: width, style: { background: '#333', color: 'white' }, children: [width, "px"] }, width))) }), selectedItem?.type !== 'line' && selectedItem?.type !== 'sharpie' && selectedItem?.type !== 'path' && (jsxRuntime.jsxs("div", { className: "d-flex align-items-center gap-50", children: [jsxRuntime.jsx(ColorPicker, { value: selectedItem?.fillColor || '#ffffff', onChange: handleFillColorChange, title: t('toolbar.fill.color') }), selectedItem?.fillColor && selectedItem?.fillColor !== 'transparent' && (jsxRuntime.jsx("span", { className: "text-white hover", onClick: handleClearFill, title: t('toolbar.clear.fill'), children: "\u2715" }))] }))] }))] }));
};
...
const TextEditor = ({ editingText, editingValue, editingTextItem, canvasRef, zoomLevel, onValueChange, onBlur, }) => {
    ...
    return (jsxRuntime.jsx("div", { contentEditable: true, suppressContentEditableWarning: true, onInput: (e) => onValueChange(e.currentTarget.textContent || ''), onBlur: (e) => {
...
const EditorCanvas = ({ onMouseDown, onMouseMove, onMouseUp, onDoubleClick, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: "dk-image-editor__canvas", children: [jsxRuntime.jsx(FloatingToolbar, { visible: hasSelection || !!editingText, editingText: editingText, editingTextItem: editingTextItem, selectionPluginRef: selectionPluginRef, onDelete: () => selectionPluginRef.current?.deleteSelected(), onCopy: () => selectionPluginRef.current?.copySelected(), onMoveToFront: () => handleLayerAction('front'), onMoveToBack: () => handleLayerAction('back'), onMoveUp: () => handleLayerAction('forward'), onMoveDown: () => handleLayerAction('backward'), onTextItemChange: handleTextItemChange }), jsxRuntime.jsx(TextEditor, { editingText: editingText, editingValue: editingValue, editingTextItem: editingTextItem, canvasRef: canvasRef, zoomLevel: zoomLevel, onValueChange: handleValueChange, onBlur: handleTextBlur }), jsxRuntime.jsx("canvas", { ref: canvasRef, className: `dk-image-editor__image-canvas dk-image-editor__image-canvas--${activeTool}`, onMouseDown: onMouseDown, onMouseMove: onMouseMove, onMouseUp: onMouseUp, onDoubleClick: onDoubleClick })] }));
};

function IconRedo(props) {
    const width = props.size || props.width || 16;
    const height = props.size || props.height || 16;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [jsxRuntime.jsx("path", { d: "M21 7v6h-6" }), jsxRuntime.jsx("path", { d: "M3 17a9 9 0 019-9 9 9 0 016 2.3l3 2.7" })] }));
}

function IconUndo(props) {
    const width = props.size || props.width || 16;
    const height = props.size || props.height || 16;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [jsxRuntime.jsx("path", { d: "M3 7v6h6" }), jsxRuntime.jsx("path", { d: "M21 17a9 9 0 00-9-9 9 9 0 00-6 2.3L3 13" })] }));
}

function IconUpload(props) {
    const width = props.size || props.width || 16;
    const height = props.size || props.height || 16;
    return (jsxRuntime.jsxs("svg", { ...props, width: width, height: height, className: props.className, style: props.style, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [jsxRuntime.jsx("path", { d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" }), jsxRuntime.jsx("polyline", { points: "7,10 12,5 17,10" }), jsxRuntime.jsx("line", { x1: "12", y1: "5", x2: "12", y2: "15" })] }));
}

const IconZoomIn = ({ size = 16, className = '' }) => {
    return (jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: className, children: [jsxRuntime.jsx("circle", { cx: "11", cy: "11", r: "8" }), jsxRuntime.jsx("path", { d: "m21 21-4.35-4.35" }), jsxRuntime.jsx("line", { x1: "11", y1: "8", x2: "11", y2: "14" }), jsxRuntime.jsx("line", { x1: "8", y1: "11", x2: "14", y2: "11" })] }));
};

const IconZoomOut = ({ size = 16, className = '' }) => {
    return (jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: className, children: [jsxRuntime.jsx("circle", { cx: "11", cy: "11", r: "8" }), jsxRuntime.jsx("path", { d: "m21 21-4.35-4.35" }), jsxRuntime.jsx("line", { x1: "8", y1: "11", x2: "14", y2: "11" })] }));
};
...
const ZoomControls = () => {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("button", { onClick: handleZoomIn, className: "dk-image-editor__action-btn", title: t('header.zoom.in'), children: jsxRuntime.jsx(IconZoomIn, { size: 16 }) }), jsxRuntime.jsxs("button", { onClick: handleZoomReset, className: "dk-image-editor__action-btn", title: t('header.zoom.reset'), children: [Math.round(zoomLevel * 100), "%"] }), jsxRuntime.jsx("button", { onClick: handleZoomOut, className: "dk-image-editor__action-btn", title: t('header.zoom.out'), children: jsxRuntime.jsx(IconZoomOut, { size: 16 }) })] }));
};
...
const EditorHeader = ({ onClose, onConfirm, onUndo, onRedo, onSave, onUpload, showCloseButton = true, showDownloadButton = true, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: "dk-image-editor__header", children: [jsxRuntime.jsxs("div", { className: "dk-image-editor__header-left", children: [jsxRuntime.jsx("input", { ref: fileInputRef, type: "file", accept: "image/*", onChange: handleFileChange, style: { display: 'none' } }), jsxRuntime.jsx("button", { onClick: handleUploadClick, className: "dk-image-editor__action-btn", title: t('header.upload'), children: jsxRuntime.jsx(IconUpload, {}) }), jsxRuntime.jsx("button", { onClick: () => {
                            onUndo();
                            selectionPluginRef.current?.clearSelection();
                        }, className: "dk-image-editor__action-btn", title: t('header.undo'), children: jsxRuntime.jsx(IconUndo, {}) }), jsxRuntime.jsx("button", { onClick: () => {
                            onRedo();
                            selectionPluginRef.current?.clearSelection();
                        }, className: "dk-image-editor__action-btn", title: t('header.redo'), children: jsxRuntime.jsx(IconRedo, {}) }), jsxRuntime.jsx(ZoomControls, {})] }), jsxRuntime.jsxs("div", { className: "dk-image-editor__header-right ms-2", children: [showDownloadButton && (jsxRuntime.jsx("button", { onClick: onSave, className: "dk-image-editor__save-btn", children: t('header.download') })), onConfirm && (jsxRuntime.jsx("button", { onClick: onConfirm, className: "dk-image-editor__confirm-btn", children: t('header.confirm') })), showCloseButton && (jsxRuntime.jsx("button", { onClick: () => {
...
const ToolSidebar = ({ tools }) => {
    ...
    const { updateUIState } = useEditorActions();
    const { t } = useTranslation();
    return (jsxRuntime.jsx("div", { className: "dk-image-editor__sidebar", children: tools.map((tool) => (jsxRuntime.jsxs("button", { className: `dk-image-editor__tool-btn ${activeTool === tool.id ? 'dk-image-editor__tool-btn--active' : ''}`, onClick: () => updateUIState({ activeTool: tool.id }), children: [jsxRuntime.jsx("span", { className: "dk-image-editor__tool-icon", children: tool.icon }), jsxRuntime.jsx("span", { className: "dk-image-editor__tool-name", children: t(`tool.${tool.id}`) })] }, tool.id))) }));
};
...
const useEditorInitialization = ({ canvasRef, editorRef, cropPluginRef, filterPluginRef, annotatePluginRef, stickerPluginRef, finetunePluginRef, imagePluginRef, selectionPluginRef, advancedFilterPluginRef, src, zoomLevel, setEditorState, setHasSelection, onImageLoadStart, onImageLoadEnd, }) => {
    const handleImageLoad = React.useCallback(async (source, editor) => {
        try {
...
const useEditorConfig = ({ utils, filterOptions, cropSelectPresetOptions, }) => {
    const tools = React.useMemo(() => utils.map((util) => ({ id: util, ...TOOL_MAP[util] })).filter(Boolean), [utils]);
    const filters = React.useMemo(() => [{ id: 'none', name: 'Original' }, ...filterOptions.map(([id, name]) => ({ id, name }))], [filterOptions]);
    const cropPresets = React.useMemo(() => cropSelectPresetOptions.map(([ratio, name]) => ({ ratio, name })), [cropSelectPresetOptions]);
    return { tools, filters, cropPresets };
};

const LoadingIndicator = () => {
    const { t } = useTranslation();
    return (jsxRuntime.jsxs("div", { className: "dk-image-editor__loading", children: [jsxRuntime.jsx("div", { className: "dk-image-editor__loading-spinner" }), jsxRuntime.jsx("div", { className: "dk-image-editor__loading-text", children: t('loading.image') })] }));
};
...
const DkImageEditorInternal = ({ src, onSave, onClose, onConfirm, className = '', utils = ['select', 'crop', 'filter', 'annotate', 'sticker', 'finetune', 'frame'], cropSelectPresetOptions = DEFAULT_CROP_PRESETS, annotateTools = DEFAULT_ANNOTATE_TOOLS, stickerEnableSelectImagePreset = true, filterOptions = DEFAULT_FILTER_OPTIONS, finetuneOptions = DEFAULT_FINETUNE_OPTIONS, showCloseButton = true, showDownloadButton = true, }) => {
    ...
    // 撤销/重做操作
    const handleUndo = React.useCallback(() => editorRef.current?.undo(), []);
    const handleRedo = React.useCallback(() => editorRef.current?.redo(), []);
    ...
    // 编辑器状态更新
    const handleStateChange = React.useCallback((updates) => {
        if (editorRef.current) {
    ...
    if (!isVisible)
        return null;
    return (jsxRuntime.jsxs("div", { className: `dk-image-editor ${className}`, children: [jsxRuntime.jsx(EditorHeader, { onClose: handleClose, onConfirm: handleConfirm, onUndo: handleUndo, onRedo: handleRedo, onSave: handleSave, onUpload: handleUpload, showCloseButton: showCloseButton, showDownloadButton: showDownloadButton }), jsxRuntime.jsxs("div", { className: "dk-image-editor__main", children: [jsxRuntime.jsx(ToolSidebar, { tools: tools }), isImageLoading && (jsxRuntime.jsx(LoadingIndicator, {})), jsxRuntime.jsx(EditorCanvas, { onMouseDown: handleCanvasMouseDown, onMouseMove: handleCanvasMouseMove, onMouseUp: handleCanvasMouseUp, onDoubleClick: handleCanvasDoubleClick })] }), jsxRuntime.jsx(ControlPanels, { cropPresets: cropPresets, filters: filters, annotateTools: annotateTools, finetuneOptions: finetuneOptions, onStateChange: handleStateChange, applyAdvancedFilter: applyAdvancedFilter })] }));
};
// 主组件，使用 Provider 包装
const DkImageEditor = (props) => {
    return (jsxRuntime.jsx(I18nProvider, { language: props.language || 'en', translations: props.translations, children: jsxRuntime.jsx(EditorProvider, { children: jsxRuntime.jsx(DkImageEditorInternal, { ...props }) }) }));
};
...
exports.AdvancedFilterPlugin = AdvancedFilterPlugin;
exports.AnnotatePlugin = AnnotatePlugin;
exports.ColorSpaceManager = ColorSpaceManager;
exports.CropPlugin = CropPlugin;
exports.DkImageEditor = DkImageEditor;
exports.EditorCore = EditorCore;
exports.ExifProcessor = ExifProcessor;
exports.FilterPlugin = FilterPlugin;
exports.FinetunePlugin = FinetunePlugin;
exports.I18nProvider = I18nProvider;
exports.ImageProcessor = ImageProcessor;
exports.MemoryManager = MemoryManager;
exports.StickerPlugin = StickerPlugin;
